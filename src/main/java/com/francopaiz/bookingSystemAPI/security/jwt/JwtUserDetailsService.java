...
public class JwtUserDetailsService implements UserDetailsService {
    ...
    public UserDetails loadUserByUsername(String username) throws UsernameNotFoundException {
        Optional<com.francopaiz.bookingSystemAPI.model.user.User> optionalUser = userRepository.findByEmail(username);
        if (optionalUser.isPresent()) {
            com.francopaiz.bookingSystemAPI.model.user.User userEntity = optionalUser.get();
